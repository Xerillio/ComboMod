package com.xerillio.combo.blocks;
...
public class BlockBlastFurnace extends BlockContainer
{
	...
	public BlockBlastFurnace(boolean isBurning)
	{
		super(Material.iron);
		if (isBurning)
			setUnlocalizedName("blast_furnace_lit");
		else
    ...
    {
        return Item.getItemFromBlock(ComboBlocks.blast_furnace);
    }
    ...
    public void randomDisplayTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
    {
        if (this.isBurning)
        {
            ...
            switch (BlockBlastFurnace.SwitchEnumFacing.FACING_LOOKUP[enumfacing.ordinal()])
            {
                case 1:
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float hitX, float hitY, float hitZ)
    {
        if (!worldIn.isRemote)
        {
            ...
            {
                playerIn.openGui(ComboMod.instance, ComboMod.GuiEnum.BLAST_FURNACE.ordinal(), worldIn, pos.getX(), pos.getY(), pos.getZ());
            }
        }
        return true;
    }
